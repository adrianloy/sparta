...
class Ui_MainWindow(QtCore.QObject):
    def setupUi(self, MainWindow):
        ...
        self.sizePolicy.setHorizontalStretch(
            0)  # this specifies that the widget will keep its width when the window is resized
        ...
        self.sizePolicy2.setHorizontalStretch(
            1)  # this specifies that the widget will expand its width when the window is resized
    ...
    def setupLeftPanel(self):
        ...
        self.advancedIcon.addPixmap(QtGui.QPixmap(_fromUtf8("./images/advanced.png")), QtGui.QIcon.Normal,
                                    QtGui.QIcon.Off)
        ...
        self.addHostsOverlay = QtGui.QTextEdit(
            self.HostsTab)  # the overlay widget that appears over the hosttableview
    ...
    def setupRightPanel(self):
        ...
        self.splitter_3.setSizePolicy(
            self.sizePolicy2)  # this makes the tools tab stay the same width when resizing the window
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.ServicesTabWidget.setTabText(self.ServicesTabWidget.indexOf(self.ScriptsTab),
                                          QtGui.QApplication.translate("MainWindow", "Scripts", None,
                                                                       QtGui.QApplication.UnicodeUTF8))
        ...
        self.actionSave.setToolTip(QtGui.QApplication.translate("MainWindow", "Save the current project", None,
                                                                QtGui.QApplication.UnicodeUTF8))
        self.actionSave.setShortcut(
            QtGui.QApplication.translate("MainWindow", "Ctrl+S", None, QtGui.QApplication.UnicodeUTF8))
        self.actionImportNmap.setText(
            QtGui.QApplication.translate("MainWindow", "Import nmap", None, QtGui.QApplication.UnicodeUTF8))
        self.actionImportNmap.setToolTip(
            QtGui.QApplication.translate("MainWindow", "Import an nmap xml file", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.actionAddHosts.setText(
            QtGui.QApplication.translate("MainWindow", "Add host(s) to scope", None, QtGui.QApplication.UnicodeUTF8))
        self.actionAddHosts.setShortcut(
            QtGui.QApplication.translate("MainWindow", "Ctrl+H", None, QtGui.QApplication.UnicodeUTF8))
