class Node:
    def __init__(self, data_graph):
        ...
        self.node_type_id_ = 0  # host id, service id, tool id
        self.children_ = {}
    ...
    def add_child(self, child):
        ...
        self.children_[child.node_type_id_] = child
