...
# Generated 2017-01-29 21:03:39.949785 by PyXB version 1.2.4 using Python 2.7.12.final.0
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:06f20d0e-e65e-11e6-95ad-26a4ad3a9a01')
...
class process (pyxb.binding.basis.complexTypeDefinition):
    ...
    __output = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'output'), 'output', '__AbsentNamespace0_process_output', False, pyxb.utils.utility.Location('/home/cedric/git/sparta/xml_schema/scan.xsd', 17, 12), )
    ...
    __tool._DeclarationLocation = pyxb.utils.utility.Location('/home/cedric/git/sparta/xml_schema/scan.xsd', 20, 8)
    __tool._UseLocation = pyxb.utils.utility.Location('/home/cedric/git/sparta/xml_schema/scan.xsd', 20, 8)
...
class port_ (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/home/cedric/git/sparta/xml_schema/scan.xsd', 24, 4)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element issue uses Python identifier issue
    __issue = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'issue'), 'issue', '__AbsentNamespace0_port__issue', True, pyxb.utils.utility.Location('/home/cedric/git/sparta/xml_schema/scan.xsd', 26, 12), )
    ...
    __vuln = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'vuln'), 'vuln', '__AbsentNamespace0_port__vuln', True, pyxb.utils.utility.Location('/home/cedric/git/sparta/xml_schema/scan.xsd', 27, 12), )
    ...
    __number._DeclarationLocation = pyxb.utils.utility.Location('/home/cedric/git/sparta/xml_schema/scan.xsd', 29, 8)
    __number._UseLocation = pyxb.utils.utility.Location('/home/cedric/git/sparta/xml_schema/scan.xsd', 29, 8)
    ...
    __protocol._DeclarationLocation = pyxb.utils.utility.Location('/home/cedric/git/sparta/xml_schema/scan.xsd', 30, 8)
    __protocol._UseLocation = pyxb.utils.utility.Location('/home/cedric/git/sparta/xml_schema/scan.xsd', 30, 8)
    ...
    __standardService._DeclarationLocation = pyxb.utils.utility.Location('/home/cedric/git/sparta/xml_schema/scan.xsd', 31, 8)
    __standardService._UseLocation = pyxb.utils.utility.Location('/home/cedric/git/sparta/xml_schema/scan.xsd', 31, 8)
...
class host_ (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/home/cedric/git/sparta/xml_schema/scan.xsd', 35, 4)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element port uses Python identifier port
    __port = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'port'), 'port', '__AbsentNamespace0_host__port', True, pyxb.utils.utility.Location('/home/cedric/git/sparta/xml_schema/scan.xsd', 37, 12), )
    ...
    __ip._DeclarationLocation = pyxb.utils.utility.Location('/home/cedric/git/sparta/xml_schema/scan.xsd', 39, 8)
    __ip._UseLocation = pyxb.utils.utility.Location('/home/cedric/git/sparta/xml_schema/scan.xsd', 39, 8)
    ...
    __hostname._DeclarationLocation = pyxb.utils.utility.Location('/home/cedric/git/sparta/xml_schema/scan.xsd', 40, 8)
    __hostname._UseLocation = pyxb.utils.utility.Location('/home/cedric/git/sparta/xml_schema/scan.xsd', 40, 8)
...
class scan_ (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/home/cedric/git/sparta/xml_schema/scan.xsd', 44, 4)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element host uses Python identifier host
    __host = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'host'), 'host', '__AbsentNamespace0_scan__host', True, pyxb.utils.utility.Location('/home/cedric/git/sparta/xml_schema/scan.xsd', 46, 12), )
    ...
    __dateTime._DeclarationLocation = pyxb.utils.utility.Location('/home/cedric/git/sparta/xml_schema/scan.xsd', 48, 8)
    __dateTime._UseLocation = pyxb.utils.utility.Location('/home/cedric/git/sparta/xml_schema/scan.xsd', 48, 8)
...
issue = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'issue'), process, location=pyxb.utils.utility.Location('/home/cedric/git/sparta/xml_schema/scan.xsd', 22, 4))
Namespace.addCategoryObject('elementBinding', issue.name().localName(), issue)

port = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'port'), port_, location=pyxb.utils.utility.Location('/home/cedric/git/sparta/xml_schema/scan.xsd', 33, 4))
Namespace.addCategoryObject('elementBinding', port.name().localName(), port)

host = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'host'), host_, location=pyxb.utils.utility.Location('/home/cedric/git/sparta/xml_schema/scan.xsd', 42, 4))
Namespace.addCategoryObject('elementBinding', host.name().localName(), host)

scan = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'scan'), scan_, location=pyxb.utils.utility.Location('/home/cedric/git/sparta/xml_schema/scan.xsd', 50, 4))
...
process._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'output'), pyxb.binding.datatypes.string, scope=process, location=pyxb.utils.utility.Location('/home/cedric/git/sparta/xml_schema/scan.xsd', 17, 12)))
...
def _BuildAutomaton_ ():
    ...
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(process._UseForTag(pyxb.namespace.ExpandedName(None, 'output')), pyxb.utils.utility.Location('/home/cedric/git/sparta/xml_schema/scan.xsd', 17, 12))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
...
port_._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'issue'), process, scope=port_, location=pyxb.utils.utility.Location('/home/cedric/git/sparta/xml_schema/scan.xsd', 26, 12)))

port_._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'vuln'), vuln_, scope=port_, location=pyxb.utils.utility.Location('/home/cedric/git/sparta/xml_schema/scan.xsd', 27, 12)))
...
def _BuildAutomaton_2 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('/home/cedric/git/sparta/xml_schema/scan.xsd', 26, 12))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('/home/cedric/git/sparta/xml_schema/scan.xsd', 27, 12))
    counters.add(cc_1)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(port_._UseForTag(pyxb.namespace.ExpandedName(None, 'issue')), pyxb.utils.utility.Location('/home/cedric/git/sparta/xml_schema/scan.xsd', 26, 12))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(port_._UseForTag(pyxb.namespace.ExpandedName(None, 'vuln')), pyxb.utils.utility.Location('/home/cedric/git/sparta/xml_schema/scan.xsd', 27, 12))
...
host_._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'port'), port_, scope=host_, location=pyxb.utils.utility.Location('/home/cedric/git/sparta/xml_schema/scan.xsd', 37, 12)))
...
def _BuildAutomaton_3 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('/home/cedric/git/sparta/xml_schema/scan.xsd', 37, 12))
    counters.add(cc_0)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(host_._UseForTag(pyxb.namespace.ExpandedName(None, 'port')), pyxb.utils.utility.Location('/home/cedric/git/sparta/xml_schema/scan.xsd', 37, 12))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
scan_._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'host'), host_, scope=scan_, location=pyxb.utils.utility.Location('/home/cedric/git/sparta/xml_schema/scan.xsd', 46, 12)))
...
def _BuildAutomaton_4 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('/home/cedric/git/sparta/xml_schema/scan.xsd', 46, 12))
    counters.add(cc_0)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(scan_._UseForTag(pyxb.namespace.ExpandedName(None, 'host')), pyxb.utils.utility.Location('/home/cedric/git/sparta/xml_schema/scan.xsd', 46, 12))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
