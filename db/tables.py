...
class nmap_session(Entity):
    ...
    def __init__(self, filename, start_time, finish_time, nmap_version='', scan_args='', total_hosts='0', up_hosts='0',
                 down_hosts='0'):
...
class nmap_host(Entity):
    ...
    def __init__(self, os_match='', os_accuracy='', ip='', ipv4='', ipv6='', macaddr='', status='', hostname='',
...
class process(Entity):
    ...
    def __init__(self, pid, name, tabtitle, hostip, port, protocol, command, starttime, endtime, outputfile, status,
                 processOutputId):
        self.display = 'True'
        self.pid = pid
        self.name = name
